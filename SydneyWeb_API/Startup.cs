...
using SydneyWeb_API.Models;
using SydneyWeb_API;
using SydneyWeb_API.Authentication;
...
namespace SydneyWeb_API
{
    public class Startup
    {
                ...
                c.AddSecurityRequirement(new OpenApiSecurityRequirement {
        {
            ...
            //services.AddSwaggerGen(options => { options.SwaggerDoc("v2", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "My API", Version = "v2", Description = "Test for Company", }); });
